...
export default function Tasks() {
  ...
  const fetchTasks = async () => {
    try {
      const response = await axios.get(
        "https://prodigyapp.onrender.com/api/tasks",
        {
  ...
  const handleCreateTask = async (taskData) => {
    try {
      await axios.post("https://prodigyapp.onrender.com/api/tasks", taskData, {
        withCredentials: true,
      });
      fetchTasks();
    } catch (error) {
  ...
  const handleUpdateTask = async (taskData) => {
    try {
      await axios.put(
        `https://prodigyapp.onrender.com/api/tasks/${selectedTask._id}`,
        taskData,
        {
          withCredentials: true,
        }
  ...
  const handleDeleteTask = async (taskId) => {
    if (window.confirm("Are you sure you want to delete this task?")) {
      try {
        await axios.delete(
          `https://prodigyapp.onrender.com/api/tasks/${taskId}`,
          {
            withCredentials: true,
          }
        );
